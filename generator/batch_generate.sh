...
/opt/homebrew/bin/python3 generate_SDL_clipboard.py > ../lib/sdl2_clipboard.rb
/opt/homebrew/bin/python3 generate_SDL_cpuinfo.py > ../lib/sdl2_cpuinfo.rb
/opt/homebrew/bin/python3 generate_SDL_error.py > ../lib/sdl2_error.rb
...
/opt/homebrew/bin/python3 generate_SDL_init.py > ../lib/sdl2_init.rb
...
/opt/homebrew/bin/python3 generate_SDL_locale.py > ../lib/sdl2_locale.rb
...
/opt/homebrew/bin/python3 generate_SDL_power.py > ../lib/sdl2_power.rb
/opt/homebrew/bin/python3 generate_SDL_rect.py > ../lib/sdl2_rect.rb
...
/opt/homebrew/bin/python3 generate_SDL_syswm.py > ../lib/sdl2_syswm.rb
/opt/homebrew/bin/python3 generate_SDL_timer.py > ../lib/sdl2_timer.rb
/opt/homebrew/bin/python3 generate_SDL_thread.py > ../lib/sdl2_thread.rb
/opt/homebrew/bin/python3 generate_SDL_touch.py > ../lib/sdl2_touch.rb
/opt/homebrew/bin/python3 generate_SDL_version.py > ../lib/sdl2_version.rb
/opt/homebrew/bin/python3 generate_SDL_video.py > ../lib/sdl2_video.rb
/opt/homebrew/bin/python3 generate_SDL_vulkan.py > ../lib/sdl2_vulkan.rb

/opt/homebrew/bin/python3 generate_SDL_ttf.py > ../lib/sdl2_ttf.rb
/opt/homebrew/bin/python3 generate_SDL_image.py > ../lib/sdl2_image.rb
/opt/homebrew/bin/python3 generate_SDL_mixer.py > ../lib/sdl2_mixer.rb
# /opt/homebrew/bin/python3 generate_SDL2_gfxPrimitives.py > ../lib/sdl2_gfxPrimitives.rb
