...
module SDL2
  ...
  def self.setup_ttf_symbols()
    ...
    args = {
      ...
      :TTF_RenderText_Solid => [:pointer, :pointer, SDL_Color.by_value],
      :TTF_RenderUTF8_Solid => [:pointer, :pointer, SDL_Color.by_value],
      :TTF_RenderUNICODE_Solid => [:pointer, :pointer, SDL_Color.by_value],
      :TTF_RenderText_Solid_Wrapped => [:pointer, :pointer, SDL_Color.by_value, :uint],
      :TTF_RenderUTF8_Solid_Wrapped => [:pointer, :pointer, SDL_Color.by_value, :uint],
      :TTF_RenderUNICODE_Solid_Wrapped => [:pointer, :pointer, SDL_Color.by_value, :uint],
      :TTF_RenderGlyph_Solid => [:pointer, :ushort, SDL_Color.by_value],
      :TTF_RenderGlyph32_Solid => [:pointer, :uint, SDL_Color.by_value],
      :TTF_RenderText_Shaded => [:pointer, :pointer, SDL_Color.by_value, SDL_Color.by_value],
      :TTF_RenderUTF8_Shaded => [:pointer, :pointer, SDL_Color.by_value, SDL_Color.by_value],
      :TTF_RenderUNICODE_Shaded => [:pointer, :pointer, SDL_Color.by_value, SDL_Color.by_value],
      :TTF_RenderText_Shaded_Wrapped => [:pointer, :pointer, SDL_Color.by_value, SDL_Color.by_value, :uint],
      :TTF_RenderUTF8_Shaded_Wrapped => [:pointer, :pointer, SDL_Color.by_value, SDL_Color.by_value, :uint],
      :TTF_RenderUNICODE_Shaded_Wrapped => [:pointer, :pointer, SDL_Color.by_value, SDL_Color.by_value, :uint],
      :TTF_RenderGlyph_Shaded => [:pointer, :ushort, SDL_Color.by_value, SDL_Color.by_value],
      :TTF_RenderGlyph32_Shaded => [:pointer, :uint, SDL_Color.by_value, SDL_Color.by_value],
      :TTF_RenderText_Blended => [:pointer, :pointer, SDL_Color.by_value],
      :TTF_RenderUTF8_Blended => [:pointer, :pointer, SDL_Color.by_value],
      :TTF_RenderUNICODE_Blended => [:pointer, :pointer, SDL_Color.by_value],
      :TTF_RenderText_Blended_Wrapped => [:pointer, :pointer, SDL_Color.by_value, :uint],
      :TTF_RenderUTF8_Blended_Wrapped => [:pointer, :pointer, SDL_Color.by_value, :uint],
      :TTF_RenderUNICODE_Blended_Wrapped => [:pointer, :pointer, SDL_Color.by_value, :uint],
      :TTF_RenderGlyph_Blended => [:pointer, :ushort, SDL_Color.by_value],
      :TTF_RenderGlyph32_Blended => [:pointer, :uint, SDL_Color.by_value],
