...
module SDL
  ...
  def self.setup_stdinc_symbols(output_error = false)
    ...
    args = {
      ...
      :SDL_swprintf => [:pointer, :ulong, :pointer],
      :SDL_vsnprintf => [:pointer, :ulong, :pointer, :pointer],
      :SDL_vswprintf => [:pointer, :ulong, :pointer, :pointer],
